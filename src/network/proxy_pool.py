...
class ProxyPool:
    ...
    def build(
        ...
        *,
        source_url: str,
        stage1_url: str,
        stage2_probe: Callable[[Dict[str, str]], Tuple[bool, Optional[int], Optional[str]]],
        fetch_limit: int = 300,
        ...
        """
        all_proxies = fetch_proxy_list(source_url, timeout_seconds=8.0, limit=fetch_limit)
        if not all_proxies:
        ...
        stage2_results = cls._run_stage([r.proxy for r in s1_ok], stage2_worker, max_workers)
